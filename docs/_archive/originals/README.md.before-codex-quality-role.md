...
| Test/lint/build tooling | Build script configured; lint/test not configured yet |
...
There are currently no lint or test scripts because no framework-level tooling has been selected yet.
...
10. lint, format, and test configuration;

...
- AI summary API foundation exists, but no production AI call is enabled by default.
...
- production category-aware summarization;
...
3. Verify the GitHub Actions scheduled RSS update on the public repository.
